...
public class PrzewodnikStudencki extends Student {
    ...
    public PrzewodnikStudencki(String imie, String nazwisko, Plec plec, double regeneracja) {super(imie, nazwisko, plec, 5.0, regeneracja, 18);}

    @Override
    public void opiszWycieczke(Wycieczka wycieczka) {
        mow("Dzień dobry Państwu. Teraz opowiem Wam o wycieczce.");
